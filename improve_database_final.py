...
# -*- coding: utf-8 -*-
"""
Improve Database Format - Final Version
Script cải thiện định dạng database với cấu trúc đầy đủ
"""
...
def main():
    print("🚀 IMPROVE DATABASE FORMAT - FINAL VERSION")
    print("=" * 60)
    ...
    try:
        ...
        cursor.execute("SELECT TOP 2 Id, Name, Condition, Gender FROM Products")
        sample_data = cursor.fetchall()
        print("\nDữ liệu mẫu (trước cải thiện):")
