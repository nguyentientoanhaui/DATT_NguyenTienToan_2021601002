-- Script đơn giản: Chỉ fix encoding, không thay đổi collation
-- Tránh lỗi index bằng cách không thay đổi cấu trúc bảng

USE [Shopping_Demo]
GO

-- PHẦN 1: FORCE FIX DỮ LIỆU BỊ CORRUPT (KHÔNG THAY ĐỔI COLLATION)

-- 1.1. Thay thế hoàn toàn các giá trị Condition bị lỗi
UPDATE Products 
...
-- 1.2. Thay thế hoàn toàn các giá trị Gender bị lỗi
UPDATE Products 
SET Gender = N'Nam'
...
-- 1.3. Thay thế hoàn toàn các giá trị Certificate bị lỗi
UPDATE Products 
...
-- 1.4. Thay thế hoàn toàn các giá trị WarrantyInfo bị lỗi
UPDATE Products 
