...
namespace Shopping_Demo.Migrations
{
    ...
    [Migration("20250421174022_RemoveConfirmPasswordFromAppUser")]
    partial class RemoveConfirmPasswordFromAppUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shopping_Demo.Models.RatingModel", b =>
                {
                    b.HasOne("Shopping_Demo.Models.ProductModel", "Product")
                        .WithOne("Rating")
                        .HasForeignKey("Shopping_Demo.Models.RatingModel", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
