...
# -*- coding: utf-8 -*-
"""
Improve Database Format - With Foreign Key Handling
Script cải thiện định dạng database với xử lý foreign key constraints
"""
...
def main():
    print("🚀 IMPROVE DATABASE FORMAT - WITH FK HANDLING")
    print("=" * 60)
    ...
    try:
        ...
        print(f"\nForeign Key constraints trên bảng Products: {len(fk_constraints)}")
        ...
        # Bước 6: Xử lý Foreign Key và thay thế bảng
        print("\n6️⃣ XỬ LÝ FOREIGN KEY VÀ THAY THẾ BẢNG")
        print("-" * 40)
        ...
        print("✅ Foreign key constraints đã được xử lý")
