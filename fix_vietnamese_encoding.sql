...
-- Chạy script này để sửa các ký tự tiếng Việt bị lỗi

USE [Shopping_Demo]
GO

-- 1. Sửa lỗi encoding cho trường Condition
UPDATE Products 
SET Condition = 
    CASE 
...
-- 2. Sửa lỗi encoding cho trường Gender
UPDATE Products 
SET Gender = 
    CASE 
...
-- 3. Sửa lỗi encoding cho trường Certificate
UPDATE Products 
SET Certificate = 
    CASE 
...
-- 4. Sửa lỗi encoding cho trường WarrantyInfo
UPDATE Products 
SET WarrantyInfo = 
    CASE 
...
-- 5. Hiển thị kết quả sau khi sửa
SELECT 
    'Encoding fixed!' as Message,
...
-- 6. Hiển thị một số sản phẩm để kiểm tra
SELECT TOP 5
    Id,
    Name,
    Price,
